...
public class FbConfigIT {
  ...
  public void testCreateFbConfigBlankTenantId() {
    createTenant(createTenantBody()).then().statusCode(201);
  ...
  public void testCreateFbConfigTenantIdTooLong() {
    createTenant(createTenantBody()).then().statusCode(201);
  ...
  public void testCreateFbConfigHeaderMismatch() {
    createTenant(createTenantBody()).then().statusCode(201);
  ...
  public void testGetFbConfigMissingHeader() {
    Response response = given().get("/v1/admin/config/fb-config");
  ...
  public void testUpdateFbConfigMissingHeader() {
    ...
    Response response =
        given()
            ...
            .body(updateBody)
            .patch("/v1/admin/config/fb-config");
  ...
  public void testDeleteFbConfigMissingHeader() {
    Response response = given().delete("/v1/admin/config/fb-config");
    response.then().statusCode(SC_UNAUTHORIZED);
  }
