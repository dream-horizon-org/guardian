...
ALTER TABLE otp_config ADD COLUMN otp_send_block_seconds INT NOT NULL DEFAULT 86400 COMMENT 'Block duration in seconds when max resend exceeded (default 24 hours)';
