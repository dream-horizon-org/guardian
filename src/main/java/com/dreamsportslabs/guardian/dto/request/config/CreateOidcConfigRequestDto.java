...
public class CreateOidcConfigRequestDto {
  ...
  public void validate() {
    validateString(issuer, "issuer", 255, true);
    validateString(authorizationEndpoint, "authorization_endpoint", 255, true);
    validateString(tokenEndpoint, "token_endpoint", 255, true);
    validateString(userinfoEndpoint, "userinfo_endpoint", 255, true);
    validateString(revocationEndpoint, "revocation_endpoint", 255, true);
    validateString(jwksUri, "jwks_uri", 255, true);
