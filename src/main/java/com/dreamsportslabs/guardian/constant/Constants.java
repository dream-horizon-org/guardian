...
public final class Constants {
  ...
  public static final String CACHE_KEY_MFA_PASSWORD_ATTEMPTS = "mfa_password_attempts";
  public static final String CACHE_KEY_MFA_PIN_ATTEMPTS = "mfa_pin_attempts";
